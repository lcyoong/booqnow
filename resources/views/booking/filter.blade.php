...
<div class="row">
  ...
  {{ Form::filterDate('start', trans('booking.from_filter_date'), array_get($filter, 'start'), ['placeholder' => trans('booking.from_filter_date')]) }}
  {{ Form::filterDate('end', trans('booking.to_filter_date'), array_get($filter, 'end'), ['placeholder' => trans('booking.to_filter_date')]) }}
</div>
<div class="row">
