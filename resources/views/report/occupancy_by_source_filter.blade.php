...
{{ Form::hidden('rep_function', 'occupancy_by_source') }}
{{ Form::hidden('rep_class', 'Reports\OccupancyBySourceExcel') }}
<div class="row">
...
<redirect-btn label="@lang('form.clear')" redirect="{{ urlTenant('reports/occupancy_by_room') }}"></redirect-btn>
</form-ajax>
