...
<div id="receipt-edit">
  ...
  <div class="row">
    ...
    {{ Form::bsSelect('rc_method', trans('receipt.rc_method'), $pay_methods, $receipt->rc_method, ['style' => 'width:100%']) }}
    {{ Form::bsSelect('rc_type', trans('receipt.rc_type'), $rc_type, $receipt->rc_type, ['style' => 'width:100%']) }}
  </div>
  <div class="row">
