                    ...
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                            <div class="row">
                                ...
                                <div class="col-xs-3"><span class="label label-primary">Waiting 10 min</span></div>
                            </div>
                    ...
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                            <div class="row">
                                <div class="col-xs-6">Gingah (Maloney)</div>
                                <div class="col-xs-3">Table 4</div>
                                <div class="col-xs-3"><span class="label label-primary">Waiting 15 min</span></div>
                            </div>
