      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="{{ urlTenant('reports/monthly_revenue_future') }}">@lang('report.monthly_revenue_by_future_title')</a></li>
            <li><a href="{{ urlTenant('reports/cash_received') }}">@lang('report.cash_received_title')</a></li>
