  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        <li><a href="{{ urlTenant('') }}">@lang('nav.dashboard')</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="{{ urlTenant('resources') }}">@lang('nav.resource_inventory')</a></li>
            <li><a href="{{ urlTenant('resource_types') }}">@lang('nav.resource_types')</a></li>
          </ul>
        </li>
        <li><a href="{{ urlTenant('appointments') }}">@lang('nav.appointments')</a></li>
        <li><a href="{{ urlTenant('invoices') }}">@lang('nav.billing')</a></li>
