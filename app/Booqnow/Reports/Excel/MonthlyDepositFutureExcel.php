...
class MonthlyDepositFutureExcel extends ExcelReport
{
  ...
  protected function header()
  {
    ...
    $this->fillRow([trans('report.monthly_deposit_by_future_report_heading', ['ext' => "{$this->fr_year} to {$this->to_year}"])]);
  ...
  protected function getData()
  {
    for($year = $this->fr_year; $year <= $this->to_year; $year++) {
      ...
      $deposits = (new ReceiptRepository)->depositByBookedMonth($year);
