...
function tenantRoutes()
{
    ...
    Route::get('dashboard/daily', 'DashboardController@daily');
    Route::get('dashboard/onhold', 'DashboardController@expiringHold');
    Route::get('dashboard', 'DashboardController@daily');
    ...
    Route::get('addons/edit/{addon}', 'AddonController@edit');
    ...
    Route::group(['middleware' => ['permitted:bill'], 'prefix' => '/bills'], function () {
        ...
        Route::get('/{bill}/print_vat/{with}', 'BillController@downloadPrintVAT');
    ...
    Route::group(['middleware' => ['permitted:report'], 'prefix' => '/reports'], function () {
        ...
        Route::get('/monthly_revenue_future', 'ReportController@monthlyRevenueByFuture');
