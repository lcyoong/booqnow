...
class CodesTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('codes')->insert([
        ...
        ['cod_group' => 'pay_method','cod_key' => 'tt', 'cod_description' => 'Bank Transfer', 'created_by' => 1],
        ...
        ['cod_group' => 'pay_method','cod_key' => 'agtt', 'cod_description' => 'Agent Transfer', 'created_by' => 1],
